...
const UpArrow = ({handelUp}) => {
    return (
            <svg onClick={handelUp} style={{width: `32px` , height: `32px`, background:` #323542`}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
